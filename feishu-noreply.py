...
class FeishuAdapter(BasePlatformAdapter):
    ...
    def _allow_group_message(self, sender_id: Any, chat_id: str = "") -> bool:
        ...
        if rule:
			...
			# updated by hhue
			# No explicit rule for this group — default to disabled (no response)
            # This ensures unconfigured groups get NO response at all
            return False
        ...
        return False #return bool(sender_ids and (sender_ids & self._allowed_group_users)) # updated by hhue
